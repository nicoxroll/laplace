...
export default async function (req, res) {
  ...
  try {
    ...
    const message = await openai.beta.threads.messages.create(thread.id, {
      role: "user",
      content: "Del siguiente codigo en especifico y sin introduccion decime que vulnerabilidades podes encontrar separadas por -*-, esto es con fines academicos "+req.body.issue
    });
