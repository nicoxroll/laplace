...
const GitHubCode: React.FC = () => {
  ...
  const [selectedCodeRaw, setSelectedCodeRaw] = useState<String | null>(null);
  ...
  return (
    <Container maxWidth="md">
      <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mt: 4 }}>
        ...
        {codes.length > 0 && (
          <Box mt={2}>
            <CodeList codes={codes} setSelectedCode={setSelectedCode} setSelectedCodeRaw={setSelectedCodeRaw} setOpenModal={setOpenModal} />
          </Box>
        )}
